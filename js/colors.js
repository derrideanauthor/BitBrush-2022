...
Color.prototype.RGBtoHSL = function (){
	...
	this.s = (saturation * 100) | 0;
	this.l = (lightness * 100) | 0;*/
...
Color.prototype.HSLtoRGB = function (){
		...
		if (H >= 0 && H < 1) {	this.toRGB(C, X, m);	return; }
		...
		if (H >= 5 && H < 6) {	this.toRGB(C, m, X);	return; }*/
    var r, g, b;
...
////not used yet - requires mode switching
...
Color.prototype.toRGB = function (red, green, blue) {
...
//retrieve HTML compatible colour format strings
