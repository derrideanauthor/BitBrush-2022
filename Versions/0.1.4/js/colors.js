...
value=value.replace(/([0-9A-F])([0-9A-F])([0-9A-F])/i,'$1$1$2$2$3$3');this.r=parseInt(value.substr(0,2),16);this.g=parseInt(value.substr(2,2),16);this.b=parseInt(value.substr(4,2),16);this.a=1;this.RGBtoHSL()};Color.prototype.getHex=function(){var r=this.r,g=this.g,b=this.b;var value="#"+((1<<24)+(r<<16)+(g<<8)+b).toString(16).slice(1);this.hex=value;return value.toUpperCase()};Color.prototype.getRGBA=function(){var rgb='('+this.r+', '+this.g+', '+this.b,a='',v='',x=parseFloat(this.a);if(x!==1){a='a';v=', '+x}
