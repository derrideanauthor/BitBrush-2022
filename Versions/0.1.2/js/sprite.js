...
for(let f=0;f<fData.length;f++){let lData=fData[f].layerData;fDataStr+='{$num:'+fData[f].num+'$layerData:[';for(let l=0;l<lData.length;l++){fDataStr+='{$id:'+lData[l].id;fDataStr+='$img:['+lData[l].img.data+']}'}
fDataStr+=']}'}
