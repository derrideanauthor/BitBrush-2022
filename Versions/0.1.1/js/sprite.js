var Sprite=function(){this.active=!1;this.frameNum=0;this.frameData=[];this.frame;this.layerStack=[];this.layerId
this.width;this.height;this.stamp=document.createElement('canvas');this.showHiddenLayers=!0}
